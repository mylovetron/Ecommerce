...
<head>
    ...
    <!--[if lte IE 9]>
    <link rel="stylesheet" href="{{url('admin/assets/css/ace-part2.min.css" class="ace-main-stylesheet')}}" />
    <![endif]-->
            ...
            <ul class="nav ace-nav">
                            ...
                            <ul class="dropdown-menu dropdown-navbar">
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="{{url('admin/assets/images/avatars/avatar.png')}}" class="msg-photo" alt="Alex' Avatar" />
                                        <span class="msg-body">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="{{url('admin/assets/images/avatars/avatar3.png')}}" class="msg-photo" alt="Susan' Avatar')" />
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="{{url('admin/assets/images/avatars/avatar4.png')}}" class="msg-photo" alt="Bob' Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="{{url('admin/assets/images/avatars/avatar2.png')}}" class="msg-photo" alt="Kate' Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <img src="{{url('admin/assets/images/avatars/avatar5.png')}}" class="msg-photo" alt="Fred' Avatar" />
                                        <span class="msg-body">
													<span class="msg-title">
                ...
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="{{url('admin/assets/images/avatars/user.jpg')}}" alt="Jason'Photo" />
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-2">
                                                        <div class="text-center">
                                                            <img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="{{url('admin/assets/images/avatars/profile-pic.jpg')}}" />
                                                            <br />
...
<!--[if IE]>
<script src="{{url('admin/assets/js/jquery-1.11.3.min.js')}}"></script>
...
<script src="{{url('admin/assets/js/dataTables.buttons.min.js')}}"></script>
<script src="{{url('admin/assets/js/buttons.flash.min.js')}}"></script>
<script src="{{url('admin/assets/js/buttons.html5.min.js')}}"></script>
<script src="{{url('admin/assets/js/buttons.print.min.js')}}"></script>
<script src="{{url('admin/assets/js/buttons.colVis.min.js')}}"></script>
