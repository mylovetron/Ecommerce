					...
					<div id="myTabContent" class="tab-content">
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{url('user/Layout1/images/3.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/4.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/5.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/6.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/7.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/3.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/4.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/5.jpg')}}" alt=" " class="img-responsive" />
						...
						<div role="tabpanel" class="tab-pane fade" id="audio" aria-labelledby="audio-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{url('user/Layout1/images/8.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/9.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/10.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/8.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/9.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/10.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{url('user/Layout1/images/8.jpg')}}" alt=" " class="img-responsive" />
